  ...
  return (
    ...
    >
              ...
              <View style={style.imageContainer}>
                <ImageModal
                  ...
                  renderImageComponent={({ source, resizeMode, style }: any) => (
                    <Image style={style} source={source} contentFit={resizeMode} />
                  )}
                />
              </View>
            )
      ...
      <View style={style.footer}>
        <Text>
          Sometimes, you need to show the image in the list like the chat UI. The parentLayout props
          will help you limit the image display area in the modal dismiss.
        </Text>
      </View>
    </View>
  )
