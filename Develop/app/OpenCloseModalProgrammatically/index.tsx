...
export default function OpenCloseModalProgrammatically() {
  ...
  return (
    <SafeAreaView>
      <ScrollView>
        ...
        >
          <Text style={style.heading}>Open and Close modal programmatically</Text>
          <Text style={style.text}>
            - (Deprecated) modalRef: The modal will be closed after 3 seconds by calling the close
          ...
          />
          <Text style={style.text}>
            - ref: The floating button on the bottom right corner will open and close the modal.
          </Text>
          <ImageModal
            resizeMode='contain'
            imageBackgroundColor='#000000'
